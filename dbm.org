...
*** Reverse analysis
    ...
    stuff, ventually leading to creating root.artists. In the course
    of which, they end up crea ting root.artists using only those
...
* x use generate_playlist function for lastfm_similar_artists_playlist and elsewhere
